...
and returns a new array with only the even values in the array 
...
/*
Write a function called showFirstAndLast which accepts an array 
of strings and returns a new array with only the first and last 
...
returns an object with the keys as the vowel and the values 
as the number of times the vowel appears in the string. This 
function should be case insensitive so a lowercase letter and 
...
returns a new array with each value multiplied by the index it 
is currently at in the array.
...
objects and some key and returns a new array with the value 
...
of objects and returns a new array with the value of the key 
with a name of "first" and the value of a key with the name of  
...
objects and a key and returns a new array with all the objects 
...
and returns the first element in the array that has the same 
value as the second parameter or undefined if the value is not 
found in the array.
...
function find(arr, searchValue) {
    const ret = arr.filter(function(v){
...
a key, and some value to search for and returns the first found 
value in the array.
